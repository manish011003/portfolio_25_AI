...
**KEY PROJECTS:**
- **Ironclad**: Cross-platform fitness app (iOS / Android / Web) on Expo + TypeScript + Firebase. Auth + BMI/TDEE onboarding, AI meal camera log (Groq → Gemini), form checker (MediaPipe), custom training plans, Spotify soundtrack pins, achievements / medal scanning, XP ranks, gym-bro invites. Live: ironclad-bice.vercel.app. Repo: github.com/manish011003/ironclad

- **GeoStocks AI**: Geopolitical stock intelligence dashboard — 3-D globe, 8 global exchanges, Gemini-tagged news, AI prediction engine, streaming analyst chatbot. Next.js + Three.js + Gemini + Yahoo Finance. Repo: github.com/manish011003/geostocks-ai

- **AI CI/CD Log Analyzer**: Enterprise Jenkins failure analysis with LangGraph + Groq RAG, Elasticsearch kNN knowledge base, Postgres sessions, Next.js dashboard. Docker Compose stack. Repo: github.com/manish011003/ai-cicd-log-analyzer
...
- **Gym Buddy (MVP)**: Earlier AI fitness / nutrition companion concept; evolved into Ironclad for production cross-platform shipping.
