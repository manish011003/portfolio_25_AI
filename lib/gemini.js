...
**KEY PROJECTS (from GitHub manish011003):**
- **Ironclad**: Cross-platform fitness app (Expo + Firebase). Live: ironclad-bice.vercel.app
- **GeoStocks AI**: Geopolitical stock intel (Next.js + Three.js + Gemini). Live: geostocks-ai.vercel.app
- **AI CI/CD Log Analyzer**: Jenkins RAG failure diagnosis (LangGraph + Groq + Elasticsearch)
- **Benevolve AI**: Agency site for in-house tools / LLM products. Live: benevolve-ai.vercel.app
- **Spidey Tracker**: Private couples/friends map HUD (React + Firebase). Live: spidey-tracker-pi.vercel.app
- **Task Manager Agent**: FastAPI WebSocket AI agent (repo: AI-task-manager-agent-main)
- **Push-Up Counter**: MediaPipe + OpenCV form tracking (repo: push-up-counter)
- **Pani Puri Rush**: Pac-Man style browser game. Live: panipurirush.vercel.app
- **Superstorewise**: Expo / React Native storefront
- **DECOY Website**: Official org site. Live: decoywebsrc.vercel.app
- **Aasaan**: Landing + order funnel. Live: aasaan.vercel.app
- **Hungry for E-Waste (SIH 2023)**: E-waste platform finalist (repo: sih2023final)
